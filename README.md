...
| Implementations    | **[PrefixSpan Pattern Detector](https://github.com/cafejojo/schaapi/tree/master/modules/mining-pipeline/prefix-span-pattern-detector)**<br>Identifies frequent sequential patterns in graphs, with the [PrefixSpan](https://ieeexplore.ieee.org/abstract/document/1339268/) algorithm.<br>**[SPAM Pattern Detector](https://github.com/cafejojo/schaapi/tree/master/modules/mining-pipeline/spam-pattern-detector)**<br>Identifies frequent sequential patterns in graphs, with the [SPAM](https://dl.acm.org/citation.cfm?id=775109) algorithm. |
